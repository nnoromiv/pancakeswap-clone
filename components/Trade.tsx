  ...
  return (
    <div className="flex justify-center items-center py-10 px-5 relative z-[1]">
        <div className="relative z-[2]">
            <h1 className="text-secondary-darker my-5 text-6xl font-bold dark:text-white max-[426px]:text-3xl">
            ...
            <div className="flex gap-5">
                <FatButton super={{ title: "Trade Now" }} image={false} providedImage={""}  />
